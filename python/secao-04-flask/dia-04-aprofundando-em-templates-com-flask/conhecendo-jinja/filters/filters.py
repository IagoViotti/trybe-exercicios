...
# Adicionamos o filtro customizado ao ambiente, poderia ter sido qualquer nome
# O nome que for passado dos colchetes como uma string é o nome que irá ser
# chamado no template
...
# Carregando um emplate e renderizando com um contexto
